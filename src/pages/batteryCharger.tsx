...
const BatteryChargerPage = () => {
  ...
  const products: Product[] = [
    { id: 301, name: 'Battery Charger X', description: 'Reliable battery charger for industrial use', price: 2200, originalPrice: 2750, image: '/pic7.png' }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-6 py-10">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-4xl font-extrabold text-gray-900">Battery Chargers</h1>
            <p className="text-gray-600 mt-2 max-w-2xl">High quality battery chargers for industrial and residential use.</p>
          </div>
        </div>
