...
const HardnessWirePage = () => {
  ...
  const products: Product[] = [
    { id: 901, name: 'UEI-HARDNESS WIRE', description: 'Premium hardness test wire for industrial applications', price: 1425, originalPrice: 1700, image: '/h53.png' }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-6 py-10">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-4xl font-extrabold text-gray-900">Hardness Wire</h1>
            <p className="text-gray-600 mt-2 max-w-2xl">High-quality hardness test wire for precise industrial testing and applications.</p>
          </div>
        </div>
...
export default HardnessWirePage;
