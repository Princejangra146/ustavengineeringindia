    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-6 py-10">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-4xl font-extrabold text-gray-900">Control Panels</h1>
            <p className="text-gray-600 mt-2 max-w-2xl">Professional industrial control panels for complete system integration and management.</p>
          </div>
        </div>
