...
const RectifierPage = () => {
  ...
  const products: Product[] = [
    { id: 1301, name: 'Rectifier R-1', description: 'Single phase industrial rectifier', price: 950, originalPrice: 1190, image: '/pic4.png' },
    { id: 1302, name: 'Rectifier R-2', description: 'Three phase power rectifier system', price: 1450, originalPrice: 1815, image: '/pic2.png' }
  ];
