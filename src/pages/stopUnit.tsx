...
const StopUnitPage = () => {
  ...
  const products: Product[] = [
    { id: 1001, name: 'UEI-AUTOMATIC STOP UNIT FOR GENERATOR', description: 'Industrial stop/brake unit for machinery control', price: 494, originalPrice: 750, image: '/su54.png' }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-6 py-10">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-4xl font-extrabold text-gray-900">Stop Units</h1>
            <p className="text-gray-600 mt-2 max-w-2xl">Reliable stop and brake units for industrial machinery control and safety applications.</p>
          </div>
        </div>
